...
WebApp.os = (function() {
    ...
    var initOpenEvent = function() {
        ...
        $(".browser").dblclick(function() {
            ...
            $("#close").fadeIn();    
            // 浏览器面板
            var addressBar = $("<input>").attr("type", "text")
                                         .attr("placeholder", "please input address")
            ...
            var browserBone = $("<div>").attr("class", "browserBone") // 浏览器功能组件主面板
                                        .append(addressBar)
                                        .append(pageBone)
                                        .hide();
            ...
            // resize pagebone
            $(".pageBone").height($(".browserBone").height() - 54);
